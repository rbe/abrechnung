...
public class DNCustomer implements Serializable, Comparable<DNCustomer> {
...
*/
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DNCustomer)) return false;

        DNCustomer customer = (DNCustomer) o;
    ...
    @Override
    public int compareTo(DNCustomer o) {
